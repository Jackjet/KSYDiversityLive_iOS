...
/**
 Streamer button
 */
@property (nonatomic, strong) UIButton *streamerBtn;
...
- (void)initSDKUI
{
    ...
    if (self.actionViewController != nil) {
        ...
        [_actionViewController.view addSubview:self.streamerBtn];
...
- (void)streamerBtnOnClick:(UIButton *)sender{
    if (self.streamerBtnBlock != nil) {
        self.streamerBtnBlock();
    }
}
...
- (UIButton *)streamerBtn
{
    if (!_streamerBtn) {
        _streamerBtn = [[UIButton alloc]initWithFrame:CGRectMake(5, 120, 60, 60)];
        
        [_streamerBtn setTitle:@"推流" forState:UIControlStateNormal];
        
        [_streamerBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        
        [_streamerBtn.titleLabel setFont:[UIFont systemFontOfSize:15.f]];
        
        [_streamerBtn.titleLabel setTextAlignment:NSTextAlignmentLeft];
        
        [_streamerBtn addTarget:self action:@selector(streamerBtnOnClick:) forControlEvents:UIControlEventTouchUpInside];
    }
    return _streamerBtn;
}
